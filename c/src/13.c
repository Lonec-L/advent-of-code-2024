...
{
	// najprej pogledamo ostanek pri LCD, in potem pogledamo za en LCD nizje, vse veckratnike B,
	// ce je kadarkoli deljivo z A. ce ni lahko sklepamo da ni resitve. Ce je, imamo najboljso
	// mozno resitev
	long long x_lcd = lcd(m->a.x, m->b.x);

	long long r = m->prize.x % x_lcd;
